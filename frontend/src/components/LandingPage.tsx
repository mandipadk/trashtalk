        ...
        <div className="mx-auto max-w-2xl pt-32 sm:pt-48 lg:pt-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Your Trash Literally Talks.
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Trash talk isn't just banter; it's a rallying cry for a cleaner, greener future. Together, we'll turn every piece of trash into a tale of triumph!
            </p>
